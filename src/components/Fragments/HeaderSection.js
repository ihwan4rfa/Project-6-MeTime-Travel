...
const HeaderSection = () => {
    ...
    return (
        <div className='relative z-30 flex-wrap items-center w-full pt-20 sm:pt-14 md:pt-16 xl:pt-20 sm:flex h-fit'>
            ...
            <div className='absolute flex items-center w-full sm:w-1/2 h-[130px] md:h-[140px] lg:h-[170px] xl:h-[220px] overflow-hidden rounded-tl-[50px] md:rounded-tl-[70px] xl:rounded-tl-[90px] rounded-br-[50px] md:rounded-br-[70px] xl:rounded-br-[90px] rounded-2xl xl:rounded-3xl top-[430px] sm:top-32 md:top-40 xl:top-52 right-0'>
            ...
            <div className='relative flex flex-col items-center justify-center w-full sm:items-start h-fit sm:w-1/2'>
                ...
                <h1 className='font-medium w-2/3 text-primarygray text-center sm:text-left dark:text-slate-400 text-[10px] lg:text-[11px] xl:text-[13px]'>
