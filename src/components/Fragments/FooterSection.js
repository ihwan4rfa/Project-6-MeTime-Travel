    ...
    return (
        <div className='flex flex-col items-center gap-12 pb-6 text-[10px] lg:text-[11px] xl:text-[13px]'>
                    ...
                    <div className='flex flex-col gap-3 lg:gap-4 xl:gap-6'>
                        ...
                        <div className='flex flex-col items-center gap-2 sm:items-start xl:gap-3 text-primarygray dark:text-slate-400'>
                            ...
                            <div className='flex gap-2 lg:gap-3 xl:gap-4 text-[13px] lg:text-[14px] xl:text-[16px]'>
                                <a className='cursor-default cursor-scale lg:cursor-none' href='https://www.instagram.com/ihwanarfa' target='_blank'><i class="fa-brands fa-instagram hover:text-primaryred dark:hover:text-primaryyellow"></i></a>
                                <a className='cursor-default cursor-scale lg:cursor-none' href='https://web.facebook.com/ihwan.arifandi.5' target='_blank'><i class="fa-brands fa-facebook-f hover:text-primaryred dark:hover:text-primaryyellow"></i></a>
                                <a className='cursor-default cursor-scale lg:cursor-none' href='https://www.x.com/ihwanarfa' target='_blank'><i class="fa-brands fa-x-twitter hover:text-primaryred dark:hover:text-primaryyellow"></i></a>
                                <a className='cursor-default cursor-scale lg:cursor-none' href='https://www.tiktok.com/@ihwanarfa' target='_blank'><i class="fa-brands fa-tiktok hover:text-primaryred dark:hover:text-primaryyellow"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <h1 className='text-gray-400 dark:text-slate-500 text-[9px] lg:text-[10px] xl:text-[12px] text-center'>
                ...
                <span className='py-2 cursor-default cursor-pointer cursor-scale lg:cursor-none hover:text-primaryblue'>
                    <a className='cursor-default cursor-scale lg:cursor-none' href='https://github.com/ihwan4rfa' target='_blank'><i class="fa-brands fa-github mr-1"></i>ihwan4rfa</a>
                </span>
            </h1>
        </div>
    )
