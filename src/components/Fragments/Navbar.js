...
const Navbar = () => {
    ...
    return (
        <div className='font-poppins'>
            <nav className={`${currentPath.startsWith('/dashboard') ? 'px-10' : 'px-36 bg-opacity-[85%] backdrop-blur-lg'} ${showProfile ? 'bg-opacity-100' : ''} z-50 fixed flex items-center justify-between w-full h-16 bg-white shadow-navbar text-primaryblack`}>
