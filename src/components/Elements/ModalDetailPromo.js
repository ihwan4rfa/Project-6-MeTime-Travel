...
const ModalDetailPromo = ({ showEditPromo, setShowEditPromo, selectedPromo }) => {
    ...
    return (
        <>
            <div className={`absolute z-20 w-full h-full opacity-40 bg-primaryblack ${showEditPromo === true ? '' : 'hidden'}`}></div>
            <div className={`${showEditPromo === true ? '' : 'hidden'} absolute z-30 flex items-center justify-center w-full h-full`}>
                <div className={`bg-white shadow-lg rounded-lg text-[13px] flex justify-center relative text-primaryblack h-fit w-[850px]`}>
                        ...
                        <div className='flex flex-col items-start justify-center w-full gap-4 h-fit'>
                            <div className='flex w-full gap-4'>
                                ...
                                <div className='flex flex-col w-3/5 gap-4'>
                                    <input defaultValue={selectedPromo.title} type="text" name="title" id="title" placeholder="Promo Name" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                    <textarea defaultValue={selectedPromo.description} name="description" id="description" placeholder="Description" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full h-24 outline-none" />
                                    <div className='flex gap-4'>
                                        <input defaultValue={selectedPromo.terms_condition} type="text" name="terms_condition" id="terms_condition" placeholder="Terms and Condition" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                        <input defaultValue={selectedPromo.promo_code} type="text" name="promo_code" id="promo_code" placeholder="Promo Code" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                    </div>
                                </div>
                            </div>
                            <div className='flex w-full gap-4'>
                                ...
                                <div className='flex w-3/5 gap-4'>
                                    <input type="number" name="promo_discount_price" id="promo_discount_price" placeholder="Discount Price" defaultValue={selectedPromo.promo_discount_price} className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                    <input type="number" name="minimum_claim_price" id="minimum_claim_price" placeholder="Minimum Claim Price" defaultValue={selectedPromo.minimum_claim_price} className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                </div>
                            </div>
                        </div>
