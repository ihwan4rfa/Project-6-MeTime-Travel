            ...
            <div className={`${showDetailPromo === true ? '' : 'hidden'} absolute z-30 flex items-center justify-center w-full h-full`}>
                <div className={`bg-white dark:bg-primaryblack shadow-lg rounded-lg text-[13px] flex justify-center relative text-primaryblack dark:text-slate-200 h-fit w-fit`}>
                    <div className='absolute flex justify-end w-full p-2'>
                        <button onClick={handleCloseEditPromo} className='w-8 h-8 text-xl rounded-lg hover:text-primaryred dark:hover:text-primaryred'><i class=" fa-solid fa-xmark"></i></button>
                    </div>
                    <div className={`flex flex-col items-center justify-center w-full h-full p-5`}>
                        <div className='flex flex-col items-start justify-center w-full gap-4 h-fit'>
                            <div className='flex w-full gap-4'>
                                ...
                                <div className='flex flex-col w-[450px] gap-1 text-primaryblack dark:text-slate-200'>
                                    <h1 className='text-2xl font-semibold capitalize'>{selectedPromo.title}</h1>
                                    <div className='flex justify-between w-full py-2 pl-3 pr-2 mb-2 rounded-lg bg-slate-100 dark:bg-slate-700'>
