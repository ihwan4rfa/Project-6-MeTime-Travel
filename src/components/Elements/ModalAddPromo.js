...
const ModalAddPromo = ({ showAddPromo, setShowAddPromo }) => {
    ...
    return (
        <>
            <div className={`absolute z-20 w-full h-full opacity-40 bg-primaryblack ${showAddPromo === true ? '' : 'hidden'}`}></div>
                        ...
                        <div className='flex flex-col items-start justify-center w-full gap-4 h-fit'>
                            <div className='flex w-full gap-4'>
                                ...
                                <div className='flex flex-col w-3/5 gap-4'>
                                    <input type="text" name="title" id="title" placeholder="Promo Name" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                    ...
                                    <div className='flex gap-4'>
                                        <input type="text" name="terms_condition" id="terms_condition" placeholder="Terms and Condition" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                        <input type="text" name="promo_code" id="promo_code" placeholder="Promo Code" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                    </div>
                                </div>
                            </div>
                            <div className='flex w-full gap-4'>
                                ...
                                <div className='flex w-3/5 gap-4'>
                                    <input type="number" name="promo_discount_price" id="promo_discount_price" placeholder="Discount Price" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                    <input type="number" name="minimum_claim_price" id="minimum_claim_price" placeholder="Minimum Claim Price" className="bg-slate-200 placeholder:text-slate-400 text-primaryblack py-[10px] px-4 text-[13px] rounded-lg w-full outline-none" />
                                </div>
                            </div>
                        </div>
